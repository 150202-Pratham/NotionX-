...
exports.capturePayment = async(req, res) => {
    ...
    for(const course_id of courses) {
        ...
        try{
            ...
            // Fix: Convert userId to string for comparison with stored ObjectIds
    ...
    try{
        ...
        return res.status(500).json({success:false, message:"Could not Initiate Order: " + error.message});
    }
...
exports.verifyPayment = async(req, res) => {
    ...
    console.log("Verify Payment called with:", {razorpay_order_id, razorpay_payment_id, courses, userId});

    if(!razorpay_order_id ||
        !razorpay_payment_id ||
        !razorpay_signature || !courses || !userId) {
            console.error("Missing payment verification fields");
            return res.status(200).json({success:false, message:"Payment Failed - Missing fields"});
    }
